        ...
        if (isDualR3(uiid)) {
            return (
                <DoubleDualR3Card
                    ...
                    channels={[
                        { stat: data.params.switches[0].switch, name: data.tags ? data.tags[0] : 'channel 1' },
                        { stat: data.params.switches[1].switch, name: data.tags ? data.tags[1] : 'channel 2' },
                    ]}
            ...
            return (
                <IW100Card key={key} deviceData={{ fwVersion: data.params.fwVersion, ...deviceData }} channel={{ stat: data.params.switch, name: 'channel' }} ballData={ballData} />
            );
            ...
            return (
                <PowerDetCard
                    key={deviceId}
                    deviceData={{ fwVersion: data.params.fwVersion, ...deviceData }}
                    channel={{ stat: data.params.switch, name: 'channel' }}
                    power='149W'
                />
            );
            ...
            if (uiid === 1 && type === 'diy') {
                ...
                for (let i = 0; i < 2; i++)
                    ...
                    else channels.push({ name: `channel ${i + 1}`, stat: data.params.switches[i].switch });
            ...
            return (
                <TempCard
                    ...
                    temp={`${data.params.currentTemperature}C`}
                />
            );
        } else {
