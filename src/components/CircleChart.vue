<template>
    <div class="circle-chart">
        <Icon style="width:300px; height:300px;">
            <template #component>
<svg x="0px"
	 y="0px" viewBox="0 0 300 300" style="enable-background:new 0 0 595.28 841.89;">
<path id="XMLID_11_" style="fill:#1890FF;" d="M87.718,3.83C42.012,3.83,4.96,40.882,4.96,86.588s37.052,82.758,82.758,82.758
...
<g id="XMLID_4_">
	...
	<path id="XMLID_5_" style="clip-path:url(#XMLID_2_);fill:url(#XMLID_6_);" d="M9.766,97.701c0,0,19.816,11.512,33.963,15.565
