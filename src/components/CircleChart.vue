        ...
        <Icon :style="{ width, height }">
            <template #component>
                <svg x="0px" y="0px" viewBox="0 0 176 172" style="enable-background:new 0 0 595.28 841.89;">
                    <path id="XMLID_11_" :style="`fill:${borderColor};`" d="M87.718,3.83C42.012,3.83,4.96,40.882,4.96,86.588s37.052,82.758,82.758,82.758
                    ...
                    <g id="XMLID_4_">
                        <defs>
                            <circle id="XMLID_3_" cx="87.718" cy="85.812" r="78.87"/>
                        </defs>
                        <clipPath id="XMLID_2_">
                            <use xlink:href="#XMLID_3_"  style="overflow:visible;"/>
                        </clipPath>
                        <linearGradient id="blue" gradientUnits="userSpaceOnUse" x1="95.7665" y1="93.6394" x2="95.7665" y2="167.4632">
                            <stop  offset="0" style="stop-color:#77BFF8"/>
                            <stop  offset="1" style="stop-color:#1E92FF"/>
                        </linearGradient>
                        <linearGradient id="green" gradientUnits="userSpaceOnUse" x1="95.7665" y1="93.6394" x2="95.7665" y2="167.4632">
                            <stop  offset="0" style="stop-color:#8CDDA4"/>
                            <stop  offset="1" style="stop-color:#4ECB73"/>
                        </linearGradient>
                        <linearGradient id="yellow" gradientUnits="userSpaceOnUse" x1="95.7665" y1="93.6394" x2="95.7665" y2="167.4632">
                            <stop  offset="0" style="stop-color:#FDE586"/>
                            <stop  offset="1" style="stop-color:#FBD437"/>
                        </linearGradient>
                        <path id="XMLID_5_" :style="`clip-path:url(#XMLID_2_);fill:url(#${color});`" d="M9.766,97.701c0,0,19.816,11.512,33.963,15.565
